  ...
  ?>
    ...
    <div class="cotainer" style="margin-top: 20px;">
      <div class="row justify-content-center">
        <div class="col-md-6">
          <div class="card">
            <div class="card-header"​ style="font-family:Moul;color: #2B3990; font-size: 20px; text-align: center;">ទម្រង់ចូលប្រើប្រាស់ប្រព័ន្ធបណ្ណារ័ក្ស</div>
            <div class="card-body">
             <form role="form" action="HomePage/checkloginadmin.php" method="post">
